...
Останній commit: 2026-08-30 — d5d58af7 fix(tester): Bugs #592-#595 (DST-aware spec + QCProvider wrap + SP create hook migration + strict date DTO). Baseline було червоне (API 991/992 + Web 484/488), після коміту зелене (992/992 + 488/488). Попередній: 2026-06-20 — fix(tester): фінальна верифікація 300 E2E тестів. Виправлено 4 failed:
