...
TypeScript: ✅ 0 errors (web + api + shared) — після Bug #206-#208 fix (verified 2026-05-30, HEAD 99087b0)
Unit+Contract API: ✅ 419/419 passed (39 файлів) — без змін за tester-сесію
Web component suite: ✅ 191/191 passed (17 файлів) — +12 за tester-сесію (error.test.tsx +8, not-found.test.tsx +4)
