...
TypeScript: ✅ 0 errors (web + api + shared) — після Sprint B review fix (verified 2026-05-30, HEAD 3d5136d)
Unit+Contract API: ✅ 419/419 passed (39 файлів) — без змін за Sprint B
Web component suite: ✅ 191/191 passed (17 файлів) — без змін за Sprint B
