  ...
  return (
    <>
      <Modal
        ...
        title={isEditMode ? docNumber || 'Документ' : 'Новий складський документ'}
        size="content"
        hideClose
        extraHeaderActions={
          isEditMode ? (
            ...
            <div className="flex gap-2 items-center flex-wrap">
              ...
              {isEditMode ? (
                ...
                <Button
                  ...
                  loading={saving}
                  disabled={saving || !form.branchId || !form.warehouseId}
                  size="sm"
                >
                  Створити документ
                </Button>
            ...
            <div className="overflow-hidden">
              <div className="space-y-4 pb-1">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Input
                    label="Номер"
                    value={isEditMode && docNumber ? docNumber : '— присвоюється автоматично —'}
                    disabled
                    readOnly
