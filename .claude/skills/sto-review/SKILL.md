...
|---|---|---|
| **QUICK** | 1–2 файли змінено, явно не секьюріті-критично | §1 TS + §тільки із матриці для типу зміни |
| **AUTO** | Стандартний post-feature QA (3+ файли або нові модулі) | Матриця повністю (нижче) |

> **QUICK**: підходить для: фікс одного компонента, rename, мінорний рефактор UI. НЕ для: нових контролерів, змін сервісів з фінансовою логікою, нових Prisma моделей.
