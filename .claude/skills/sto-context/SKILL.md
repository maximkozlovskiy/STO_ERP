...
4. Перевір активні плани: `ls C:/Users/m.kozlovskiy/.claude/plans/` — якщо є `.md` файли (крім `*-agent-*.md`), прочитай **найновіший** з них (за часом модифікації). Активний план = незавершена задача з контекстом "як реалізувати".
...
План:     [Назва файлу плану або "немає активних планів"]
...
>
> Це правило діє **завжди**, крім випадків коли сам запит був `/sto-review` або `/sto-tester`.
